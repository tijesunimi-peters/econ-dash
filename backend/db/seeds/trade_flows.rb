...
# WB/FRED data for exports, imports, trade balance, FDI
# Estimated supply chain metrics
trade_data = {
  'us' => [
    { flow_type: 'exports_pct_gdp', value: 12.5, unit: '% of GDP', source: 'FRED' },
    { flow_type: 'imports_pct_gdp', value: 15.2, unit: '% of GDP', source: 'FRED' },
    { flow_type: 'trade_balance_pct_gdp', value: -2.7, unit: '% of GDP', source: 'FRED' },
  ...
  'ca' => [
    { flow_type: 'exports_pct_gdp', value: 32.1, unit: '% of GDP', source: 'FRED' },
    { flow_type: 'imports_pct_gdp', value: 34.5, unit: '% of GDP', source: 'FRED' },
    { flow_type: 'trade_balance_pct_gdp', value: -2.4, unit: '% of GDP', source: 'FRED' },
  ...
  'jp' => [
    { flow_type: 'exports_pct_gdp', value: 18.4, unit: '% of GDP', source: 'FRED' },
    { flow_type: 'imports_pct_gdp', value: 17.9, unit: '% of GDP', source: 'FRED' },
    { flow_type: 'trade_balance_pct_gdp', value: 0.5, unit: '% of GDP', source: 'FRED' },
  ...
  'au' => [
    { flow_type: 'exports_pct_gdp', value: 22.3, unit: '% of GDP', source: 'FRED' },
    { flow_type: 'imports_pct_gdp', value: 19.8, unit: '% of GDP', source: 'FRED' },
    { flow_type: 'trade_balance_pct_gdp', value: 2.5, unit: '% of GDP', source: 'FRED' },
  ...
  'de' => [
    { flow_type: 'exports_pct_gdp', value: 45.6, unit: '% of GDP', source: 'FRED' },
    { flow_type: 'imports_pct_gdp', value: 39.2, unit: '% of GDP', source: 'FRED' },
    { flow_type: 'trade_balance_pct_gdp', value: 6.4, unit: '% of GDP', source: 'FRED' },
